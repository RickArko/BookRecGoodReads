...
def load_prepared_data(data_dir: str = "data"):
    ...
    logger.info(
        f"  Sparsity: {interactions_sparse.nnz / (interactions_sparse.shape[0] * interactions_sparse.shape[1]):.4f}"
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train a collaborative filtering model using ALS")
    parser.add_argument(
        "--data_dir",
        type=str,
        default="data",
